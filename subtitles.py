...
from Plugins.Extensions.SubsSupport.compat import DMM_IMAGE
...
try:
    from enigma import iSubtitleFilterType_ENUMS, iSubtitleType_ENUMS as iSt, iGstSubtitleType_ENUMS as iGSt
except ImportError:
    iSubtitleFilterType_ENUMS = None
    iSubtitleType_ENUMS = None
    iGstSubtitleType_ENUMS = None
...
class SubsSupportEmbedded(object):
    ...
    def enableSubtitle(self, selectedSubtitle):
        ...
        if subtitle and self.selected_subtitle:
            ...
            if DMM_IMAGE:
                subtitle.enableSubtitles(self.subtitle_window.instance, self.selected_subtitle.idx)
            else:
    ...
    if isFullHD():
        skin = """
            <screen position="center,center" size="750,600" zPosition="1" >
                ...
                <widget name="subfile_label" position="0,50" size="750,70" valign="center" halign="center" font="Regular;33" transparent="1" foregroundColor="#DAA520" />
                ...
                <widget name="menu_list" position="0,210" size="750,352" itemHeight="40" transparent="1" scrollbarMode="showOnDemand" />
    ...
    def __init__(self, session, subsSettings, subdir=None, embeddedSupport=False, searchSupport=False, historySupport=False, titleList=None):
        ...
        if embeddedSupport:
            ...
            if DMM_IMAGE:
                ...
                self.embeddedList = subtitle and subtitle.getNumberOfSubtitleTracks() or 0
            else:
...
class SubsEmbeddedSelection(Screen):
    if isFullHD() and DMM_IMAGE:
        skin = """
        <screen name="SubsEmbeddedSelection" position="center,center" size="842,340">
            <widget source="streams" render="Listbox" scrollbarMode="showOnDemand" position="15,60" size="812,259" zPosition="3" transparent="1" >
                <convert type="TemplatedMultiContent">
                    {"templates":
                        {"default": (37, [
                            MultiContentEntryText(pos = (5, 0),   size = (52, 37),  font = 0, flags = RT_HALIGN_LEFT,  text = 1), # key,
                            MultiContentEntryText(pos = (60, 0),  size = (180, 37),  font = 0, flags = RT_HALIGN_LEFT,  text = 2), # number,
                            MultiContentEntryText(pos = (245, 0), size = (230, 37), font = 0, flags = RT_HALIGN_LEFT,  text = 3), # description,
                            MultiContentEntryText(pos = (500, 0), size = (350, 37), font = 0, flags = RT_HALIGN_LEFT,  text = 4), # language,
                        ], True, "showNever"),
                        },
    ...
    if DMM_IMAGE:
        def fillList(self):
            ...
            service = self.session.nav.getCurrentService()
            subtitle = service and service.subtitleTracks()
            subtitlelist = subtitle and subtitle.getNumberOfSubtitleTracks() or 0
            for idx in range(subtitlelist):
                trackinfo = subtitle.getSubtitleTrackInfo(idx)
                s_number = str(idx + 1)
                s_codec = "?"
                ...
                stream = (SelectionTrackinfoEntry(idx, trackinfo), s_number, s_language, s_codec, s_flags, selected or None)
