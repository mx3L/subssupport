                ...
                <convert type="TemplatedMultiContent">
                    {"templates":
                        {"default": (60, [
                            ...
                            MultiContentEntryText(pos = (375, 0),  size = (247, 60),  font = 0, flags = RT_HALIGN_LEFT|RT_VALIGN_CENTER,  text = 2, color=0xFF000004), # provider,
                            MultiContentEntryText(pos = (520, 0), size = (255, 60), font = 0, flags = RT_HALIGN_LEFT|RT_VALIGN_CENTER,  text = 3, color=0xFF000004), # date,
                        ], True, "showOnDemand"),
                        },
...
class SubsDownloadedSubtitlesMenu(Screen, ConfigListScreen):
    if isFullHD():
        ...
        <screen position="center,center" size="915,652" >
            ...
            <widget name="key_yellow" position="310,5" zPosition="1" size="210,67" font="Regular;30" halign="center" valign="center" backgroundColor="#a08500" shadowOffset="-2,-2" shadowColor="black" />
            <widget name="key_blue" position="460,5" zPosition="1" size="210,67" font="Regular;30" halign="center" valign="center" backgroundColor="#18188b" shadowOffset="-2,-2" shadowColor="black" />
            <eLabel position="-1,82" size="918,1" backgroundColor="#999999" />
            <widget name="config" position="0,112" size="915,540" scrollbarMode="showOnDemand" />
        </screen>"""
    else:
        skin = """
